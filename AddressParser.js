...
export class AddressParser {
    ...
    checkContactPersons(inputLine) {
        ...
        for (let a = 0; a < vornamen.length; a++) {
            vornamen[a] = vornamen[a].toLowerCase();
        }

        for (let a = 0; a < nachnamen.length; a++) {
            nachnamen[a] = nachnamen[a].toLowerCase();
        }
        ...
        for (let i = 0; i < words.length; i++) {
            ...
            if (i !== 0) {
                ...
                if (wordBefore.includes("geschäftsführer") || wordBefore.includes("ansprechpartner") || wordBefore.includes("vorstand") || wordBefore.includes("vorsitzender") || wordBefore.includes("inhaber") || wordBefore.includes("dr") && vornamen.includes(tempWord) ||
