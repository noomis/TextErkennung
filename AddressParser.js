...
export class AddressParser {
    ...
    checkStreets(inputLine) {
        ...
        let inputLineWords = inputLine.toLowerCase().split(" ");
        let probability = 0;
        let streetNames = ["str.", "stra", "weg", "allee", "gasse", "ring", "platz"];

        let restStreetNames = ["promenade", "chaussee", "boulevard", "stieg", "pfad", "feld", "kamp", "berg", "wiesen", "hof", "lanen", "pleinen", "grachten", "singels", "hoven"];
