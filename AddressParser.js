...
export class AddressParser {
    ...
    checkCity(inputLine) {
        ...
        //array to lowercase to compare with element
        ...
        cityLoop: for (let i = 0; i < inputLineWords.length; i++) {
            const element = inputLineWords[i].toLowerCase().replaceAll(",", ""); //replace commas to prevent possible inaccuracy
            ...
            //If there is a country prefix in front of the word, it is removed and gives a percentage
            for (let a = 0; a < inputLineWords.length; a++) {
                ...
                //There is a certain probability for certain regular endings of cities
                if (
